...
class Config(object):
    ...
    AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in os.environ.get('AUTH_CHANNEL', '').split()]
...
<b>©️ ɢʀᴏᴜᴘ : <a href="https://t.me/ps_discuss">𝙋𝙎 - 𝘿𝙄𝙎𝘾𝙐𝙎𝙎𝙄𝙊𝙉 𝙂𝙍𝙊𝙐𝙋</a>
